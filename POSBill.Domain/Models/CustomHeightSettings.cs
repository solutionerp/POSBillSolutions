...
namespace POSBill.Domain.Models
{
    public class CustomHeightSettings : DomainObject
    {
        ...
        {
            return "SELECT * FROM reference_db.0__sys_prefs where name = 'CustomHeight_settings'";
        }

        public override string GetUpdateQuery(string id)
        {
            return "update 0__sys_prefs set value = '" + _value + "' where name = 'CustomHeight_settings'";
        }
