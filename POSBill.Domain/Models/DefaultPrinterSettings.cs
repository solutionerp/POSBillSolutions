...
namespace POSBill.Domain.Models
{
    public class DefaultPrinterSettings : DomainObject
    {
        ...
        {
            return "SELECT * FROM reference_db.0_sys_prefs where name = 'default_printer_settings'";
        }

        public override string GetUpdateQuery(string id)
        {
            return "update 0_sys_prefs set value = '" + _value + "' where name = 'default_printer_settings'";
        }
