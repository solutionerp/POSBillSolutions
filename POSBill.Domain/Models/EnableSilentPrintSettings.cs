...
namespace POSBill.Domain.Models
{
    public class EnableSilentPrintSettings : DomainObject
    {
        ...
        {
            return "SELECT * FROM reference_db.0__sys_prefs where name = 'enable_silentPrint_settings'";
        }
        public override string GetUpdateQuery(string id)
        {
            return "update 0__sys_prefs set value = '" + _value + "' where name = 'enable_silentPrint_settings'";
        }
