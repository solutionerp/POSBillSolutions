...
namespace POSBill.Domain.Models
{
    public class EnableAutoPrintSettings : DomainObject
    {
        ...
        {
            return "SELECT * FROM reference_db.0__sys_prefs where name = 'EnableAutoPrint_settings'";
        }

        public override string GetUpdateQuery(string id)
        {
            return "update 0__sys_prefs set value = '" + _value + "' where name = 'EnableAutoPrint_settings'";
        }
